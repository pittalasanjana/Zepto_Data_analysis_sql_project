...
CREATE DATABASE zepto_analysis;USE zepto_analysis;
...
📁 Project Structure
├── dataset/│   └── zepto_inventory.csv├── sql/│   └── zepto_sql_analysis.sql├── README.md
...
Conclusion
This project demonstrates practical data analysis skills using a real-world e-commerce dataset. It highlights the ability to clean, analyze, visualize, and interpret business data to support decision-making.
It is designed as a portfolio-ready project for data analyst roles and showcases hands-on experience with Python-based data analysis workflows..
